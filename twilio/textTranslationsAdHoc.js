...
function getTranslation(iep_deadline, school_name, language, message_name){
  const date = moment(iep_deadline, 'ddd MMM DD YYYY hh:mm:ss [GMT]ZZ').format('MM-DD-YYYY');

  var translator =
  {startingMessage:
    {en: `Hey it's Little Bird from ${school_name}! Your child's IEP review is coming up. What days during the week of ${date} would you be available to meet for an hour? For example, type 'Monday, Tuesday and Wednesday'`,
    ...
    durante la semana del ${date} usted disponible para
